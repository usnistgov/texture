...
- A comparative study between micro- and macro-mechanical constitutive models developed for complex loading scenarios, **Y. Jeong**, F. Barlat, C. Tome, W. Wen (Accepted for publication in International Journal of Plasticity)
